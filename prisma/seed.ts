...
async function main() {
  ...
  const images = [
    { title: 'Кухня в стиле минимализм', description: 'Современная кухня с фасадами из МДФ, покрытыми эмалью. Белые фасады, столешница из искусственного камня.', url: '/uploads/1782336788220-0swu2q.jpg', style: 'Минимализм', category: 'Кухонная мебель', tags: JSON.stringify(['кухня', 'минимализм', 'белый']), downloads: 45 },
    { title: 'Гардеробная с островом', description: 'Просторная гардеробная с встроенной системой хранения и островом с ящиками.', url: '/uploads/1782336942856-7yo86i.jpg', style: 'Современная классика', category: 'Спальня', tags: JSON.stringify(['гардеробная', 'неоклассика', 'остров']), downloads: 32 },
    { title: 'Шкаф-купе лофт', description: 'Встроенный шкаф-купе в стиле лофт с зеркальными раздвижными дверями.', url: '/uploads/1782337086104-uac5py.jpg', style: 'Лофт', category: 'Прихожая', tags: JSON.stringify(['шкаф', 'купе', 'лофт']), downloads: 28 },
    { title: 'Обеденный стол скандинавский', description: 'Стол из натурального дерева в скандинавском стиле. Чистые линии, тёплые тона.', url: '/uploads/1782337547578-3e4ga4.jpg', style: 'Скандинавский', category: 'Гостиная', tags: JSON.stringify(['стол', 'скандинавия', 'дерево']), downloads: 19 },
    { title: 'Кухонный гарнитур джапанди', description: 'Кухня в стиле джапанди — гибрид скандинавского уюта и японской сдержанности.', url: '/uploads/1782337627756-vzhet1.jpg', style: 'Джапанди', category: 'Кухонная мебель', tags: JSON.stringify(['кухня', 'джапанди', 'натуральность']), downloads: 15 },
    { title: 'Стеллаж для книг кантри', description: 'Деревянный стеллаж в стиле кантри. Натуральное дерево, тёплые тона.', url: '/uploads/1782001538379-ffo84e.jfif', style: 'Кантри', category: 'Кабинет', tags: JSON.stringify(['стеллаж', 'кантри', 'дерево']), downloads: 22 },
  ];
