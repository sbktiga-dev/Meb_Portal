            ...
            {feedbacks.map(f => (
              <div key={f.id} className="card-base p-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button onClick={() => handleDelete(f.id)} aria-label="Удалить отзыв" className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-500 transition-colors shrink-0">
