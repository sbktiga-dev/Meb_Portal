      ...
      <div className="section-container py-10 md:py-14 max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card-base p-5">
            ...
            <p className="text-xs text-gray-400 mt-2">До 10 фотографий. Первое станет обложкой.</p>
          </div>
          ...
          <div className="card-base p-5">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)} className="input-premium w-full" placeholder="Например: Кухня минимализм" required />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" value={brand} onChange={e => setBrand(e.target.value)} className="input-premium w-full" placeholder="Название бренда (необязательно)" />
              </div>
            </div>
          </div>
