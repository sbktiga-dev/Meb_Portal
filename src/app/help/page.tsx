    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-blue-700">
          ...
          <li>Дождитесь решения администратора — вам придет уведомление на сайте о статусе заявки</li>
          <li>После одобрения перейдите в <strong>Личный кабинет → Продвижение</strong></li>
        </ol>
      </div>
