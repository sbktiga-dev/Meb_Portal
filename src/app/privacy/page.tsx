        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-3">
              <p>Изображения, документы и другие файлы, загруженные пользователями, хранятся в защищённом облачном хранилище (объектное хранилище Яндекс Облака).</p>
              <p>Файлы доступны другим пользователям Платформы в соответствии с настройками приватности владельца.</p>
              <p>Мы не несём ответственности за контент, размещённое пользователями, но оставляем за собой право удалять материалы, нарушающие правила платформы.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="text-gray-600 dark:text-gray-400 leading-relaxed space-y-3">
              <p>Платформа использует cookie-файлы (файлы cookie) для обеспечения авторизации пользователей. Токен авторизации (JWT) сохраняется в cookie для поддержания сессии.</p>
              <p>Cookie-файлы не используются для отслеживания поведения пользователей на сторонних ресурсах.</p>
              <p>Вы можете отключить cookie-файлы в настройках браузера, однако это может привести к невозможности использования платформы.</p>
            </div>
          </section>
