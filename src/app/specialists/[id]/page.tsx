          ...
          <div className="p-4 sm:p-8">
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="animate-fade-in-up stagger-2">
                <h2 className="font-bold text-gray-900 mb-3">О себе</h2>
                {specialist.description ? <p className="text-gray-600 leading-relaxed">{specialist.description}</p> : <p className="text-gray-400 italic">Не указано</p>}
              </div>
              {specialist.portfolio && (
                <div className="animate-fade-in-up stagger-3">
                  <h2 className="font-bold text-gray-900 mb-3">Портфолио</h2>
                  <p className="text-gray-600 leading-relaxed">{specialist.portfolio}</p>
                </div>
              )}
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-3 mb-6">
              {specialist.user.phone && (
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100/70 transition-colors animate-fade-in-up stagger-4">
                  ...
                  <div><p className="text-xs text-gray-400">Телефон</p><p className="font-medium text-gray-900">{specialist.user.phone}</p></div>
                </div>
              )}
            ...
            <div className="p-6 bg-gray-50 rounded-2xl animate-fade-in-up stagger-6">
              <h2 className="font-bold text-gray-900 mb-4">Оценить специалиста</h2>
              <div className="flex items-center gap-4 mb-4">
                <StarRating rating={userScore} onChange={setUserScore} size="lg" />
                <span className="text-gray-400 text-sm">{userScore > 0 ? `${userScore}/5` : 'Выберите оценку'}</span>
              </div>
