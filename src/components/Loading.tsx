...
export function SkeletonCard() {
  return (
    <div className="card-base overflow-hidden animate-pulse">
      <div className="bg-gradient-to-r from-gray-200 dark:from-gray-700 via-gray-100 dark:via-gray-800 to-gray-200 dark:to-gray-700 bg-[length:200%_100%] animate-shimmer h-48" />
...
export function SkeletonList({ count = 5 }: { count?: number }) {
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 bg-white dark:bg-gray-900 rounded-2xl shadow-card p-4 animate-pulse">
      ...
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="card-base overflow-hidden animate-pulse">
          <div className="flex items-center gap-3 p-5 pb-0">
            <div className="w-11 h-11 bg-gray-200 dark:bg-gray-700 rounded-full shrink-0" />
            <div className="flex-1 space-y-2">
              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-lg w-1/3" />
              <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded-lg w-1/5" />
            </div>
          </div>
...
export function SkeletonDocument({ count = 5 }: { count?: number }) {
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex items-center gap-5 bg-white dark:bg-gray-900 rounded-2xl shadow-card p-5 animate-pulse">
          ...
          <div className="w-28 h-10 bg-gray-200 dark:bg-gray-700 rounded-xl shrink-0" />
        </div>
      ))}
    </div>
  );
      ...
      <div className="section-container py-12">
        <div className="animate-pulse space-y-8">
          <div className="space-y-3">
            ...
            <div className="h-4 bg-gray-100 dark:bg-gray-800 rounded-lg w-96" />
          </div>
