      ...
      <div className="flex items-center gap-1">
        {shareLinks.map(link => (
          <a
            ...
            className="p-1.5 text-gray-400 hover:text-brand-500 transition-colors rounded-lg hover:bg-brand-50 dark:hover:bg-brand-500/10"
    ...
    <div className="flex items-center gap-2">
      ...
      {shareLinks.map(link => (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-600 dark:text-gray-300 hover:text-brand-500 transition-colors rounded-lg hover:bg-brand-50 dark:hover:bg-brand-500/10 border border-gray-200 dark:border-gray-700"
        >
          {link.icon}
          {link.name}
        </a>
